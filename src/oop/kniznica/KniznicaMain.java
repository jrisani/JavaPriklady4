...
public class KniznicaMain {
    public static void main(String[] args) {
        ...
        zoznamKnih.add(kniha1);   //Do zoznamKnih, cize do ArrayList-u sme doplnili prvu knihu
        zoznamKnih.add(kniha2);   //Do zoznamKnih, cize do ArrayList-u sme doplnili druhu knihu
        zoznamKnih.add(kniha3);   //Do zoznamKnih, cize do ArrayList-u sme doplnili tretiu knihu
        zoznamKnih.add(kniha4);   //Do zoznamKnih, cize do ArrayList-u sme doplnili stvrtu knihu
        zoznamKnih.add(kniha5);   //Do zoznamKnih, cize do ArrayList-u sme doplnili piatu knihu
